...
(No loops needed.)
groupSum5(0, [2, 5, 10, 4], 19) ¡æ true
groupSum5(0, [2, 5, 10, 4], 17) ¡æ true
groupSum5(0, [2, 5, 10, 4], 12) ¡æ false*/
public class a4_groupSum5 {
	...
	// Solution
    public boolean sgroupSum5(int start, int[] nums, int target) {
