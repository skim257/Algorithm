...
blueTicket(9, 1, 0) ¡æ 10
blueTicket(9, 2, 0) ¡æ 0
blueTicket(6, 1, 4) ¡æ 10*/
public class d1_blueTicket {
	public int blueTicket(int a, int b, int c) {
		  if(a+b==10||b+c==10||a+c==10)
		  return 10;
		  if(a+b==15&&(b+c<a+b||a+c<a+b))
		  return 5;
		  return 0;
		}
	
	// Solution
    public int sblueTicket(int a, int b, int c) {
        int ab = a + b;
        int bc = b + c;
        int ac = a + c;
